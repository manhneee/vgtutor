...
include_once $_SERVER['DOCUMENT_ROOT'] . '/vgtutor/functions/notification.php';
...
addNotification($conn, $user_id, $subject, "You have successfully submitted your concern about $subject. Please wait for the admin to process it.");
