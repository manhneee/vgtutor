...
<head>
    <meta charset="UTF-8">
    <title>Reviews for <?= htmlspecialchars($tutor_name) ?></title>
...
<?php include_once '../inc/upbar.php'; ?> <!-- upbar -->
        ...
        <h1 class="c-orange mt-20 mb-20 ml-20">📋 Reviews for <?= htmlspecialchars($tutor_name) ?></h1>
        ...
        <div class="courses-page d-grid m-20 gap-20">
            ...
            <?php else: ?>
                <div class="course bg-white rad-6 shadow p-20">
                    <p class="c-grey fs-14"><i class="fa fa-info-circle me-2"></i> No reviews for this tutor yet.</p>
                </div>
            <?php endif; ?>
        </div>
